...
WELCOME = (
    ...
    "🌙 /sonadora — Combinadas largas de cuota alta (también /sonadoras)\n"
    ...
    "🧪 ¿Todavía no la jugaste? Armá el talón en la casa de apuestas, "
    "sacale captura y escribí *probar* en el pie de foto: te la analizo "
    "sin guardarla ni seguirla.\n\n"
...
HELP = (
    ...
    "/sonadora o /sonadoras — Combinadas de cuota alta (probabilidad baja)\n"
